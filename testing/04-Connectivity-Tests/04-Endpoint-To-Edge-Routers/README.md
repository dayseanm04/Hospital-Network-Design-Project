...
| [**`03-Test-Floor3-Endpoint-to-Edge-Routers-Connectivity.md`**](/testing/04-Connectivity-Tests/04-Endpoint-To-Edge-Routers/03-Test-Floor3-Endpoint-to-Edge-Routers-Connectivity.mdd) | Verifies Floor 3 endpoints can reach Edge routers |
