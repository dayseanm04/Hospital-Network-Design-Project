...
# Step-by-Step Configuration (Service-ASW)
...
## Assign access ports to VLAN 240
...
## Configure the SVI (Default Gateway) for VLAN 240
...
# Configure Static IPs on IT PCs
